...
describe('jest-mock-extended', () => {
    ...
    describe('Mimic Type', () => {
        test('can use MockProxy in place of Mock Type', () => {
            const t1 = Mock_1.default();
            const i1 = Mock_1.default();
            // no TS error
    ...
    describe('calledWith', () => {
        test('can use calledWith without mock', () => {
            const mockFunc = CalledWithFn_1.default();
            mockFunc.calledWith(Matchers_1.anyNumber(), Matchers_1.anyNumber()).mockReturnValue(3);
        ...
        test('Suport mix Matchers with literals and with jest matcher', () => {
            const mockObj = Mock_1.default();
            mockObj.getSomethingWithMoreArgs.calledWith(Matchers_1.anyNumber(), expect.anything(), 3).mockReturnValue(4);
    ...
    describe('mock Date', () => {
        test('should call built-in date functions', () => {
            const mockObj = Mock_1.default({ date: new Date('2000-01-15') });
